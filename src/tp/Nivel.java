...
public class Nivel {
	...
	public int chequear() {
		if (this.getPiezas().get(0) == 0 && this.getPiezas().get(1) == 1 && this.getPiezas().get(2) == 1) {
			return 1;
		} else if ((this.getPiezas().get(0) == 1 && this.getPiezas().get(1) == 1 && this.getPiezas().get(2) == 0)) {
			return 1;
		} else if (this.getPiezas().get(0) == 0 && this.getPiezas().get(1) == 1 && this.getPiezas().get(2) == 0) {
			return 5;
		} else if (this.getPiezas().get(0) == 0 && this.getPiezas().get(1) == 0 && this.getPiezas().get(2) == 1) {
			return 100;
		} else if (this.getPiezas().get(0) == 1 && this.getPiezas().get(1) == 0 && this.getPiezas().get(2) == 0) {
			return 100;
		} else if (this.getPiezas().get(0) == 0 && this.getPiezas().get(1) == 0 && this.getPiezas().get(2) == 0) {
			return 100;
		} else {
			return 0;
		}
